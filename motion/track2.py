...
#----------------------------------------------------------------------------------------------------------------
class PiVideoStream:
    def __init__(self, resolution=(640, 480), framerate=35, rotation=0, hflip=False, vflip=False):
...
#----------------------------------------------------------------------------------------------------------------
class PiVideoTrack:
    def __init__(self, min_area=5, blur_size=10, threshold_sensitivity=15, resolution=(640, 480), framerate=32, rotation=0, hflip=False, vflip=False):
        # initialize the camera and stream
